package edu.unc.mapseq.commands.nec.clean;
...
@Command(scope = "nec-clean", name = "run-workflow", description = "Run NEC Clean Workflow")
public class RunNECCleanWorkflowAction extends AbstractAction {
    ...
    public RunNECCleanWorkflowAction() {
        super();
    }
    ...
    public Object doExecute() {
        ...
        try {
            ...
            Destination destination = session.createQueue("queue/nec.clean");
