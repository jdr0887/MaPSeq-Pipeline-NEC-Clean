...
public class NECCleanWorkflowExecutorTask extends TimerTask {
    ...
    public void run() {
        ...
        try {
            Workflow workflow = workflowDAO.findByName("NECClean");
            ...
            if (workflowPlanList != null && workflowPlanList.size() > 0) {
                ...
                for (WorkflowPlan workflowPlan : workflowPlanList) {
                    ...
                    workflowRun.setVersion(nidaUCSFCleanWorkflow.getVersion());
                    ...
                    nidaUCSFCleanWorkflow.setWorkflowPlan(workflowPlan);
